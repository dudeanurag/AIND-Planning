...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        if bool(set(action1.effect_add) & set(action2.effect_rem)) or \
           bool(set(action1.effect_rem) & set(action2.effect_add)):
            return True
        return False
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        action1 = node_a1.action
        action2 = node_a2.action
        if bool(set(action1.precond_pos) & set(action2.effect_rem)) or \
           bool(set(action1.precond_neg) & set(action2.effect_add)) or \
           bool(set(action1.effect_add) & set(action2.precond_neg)) or \
           bool(set(action1.effect_rem) & set(action2.precond_pos)):
            return True
        return False
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for node1_paren in node_a1.parents:
            for node2_paren in node_a2.parents:
                if node1_paren.is_mutex(node2_paren):
                    return True
        return False
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        if isinstance(node_s2, node_s1.__class__):
